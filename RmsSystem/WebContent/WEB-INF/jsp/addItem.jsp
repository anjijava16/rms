...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#itemIDSubmit").click(function() {
			if ($("#itemName").val() == '') {
				alert("ItemName is can't be empty ");
				return false;
			}
			if ($("#itemPrice").val() == '') {
				$("#itemPrice").focus();
...
<body>
	...
	<form action="insertItem.action" method="post">
		<div id="addTitle">
			...
			<table align="center">
				...
				<tr>
					...
					<td><input style="width: 245px;" type="text"
						name="itemTakenPlace" id="itemTakenPlace"></td>
				</tr>
				<tr>
					<td id="componentIdLable"><span class="redColor"
						id="personsWith">*</span>PersonsWith:</td>
					<td><input style="width: 245px;" type="text"
						name="personsWith" id="personWith"></td>
				</tr>
				<tr>
					<td id="componentIdLable"><span class="redColor"
						id="personsWith">*</span>Comments:</td>
					<td><input style="width: 245px;" type="text" name="comments"
						value="NA"></td>
				</tr>
				<tr>
