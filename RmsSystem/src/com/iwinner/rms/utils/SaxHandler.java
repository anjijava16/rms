...
public class SaxHandler extends DefaultHandler {
	...
	public void characters(char ch[], int start, int length)
		...
		if ("driverId".equals(currentElement())) {
			...
			driver.driverId = (driver.driverId != null ? driver.driverId : "")
					+ value;
		} else if ("name".equals(currentElement())
				&& "driver".equals(currentElementParent())) {

			Driver driver = (Driver) this.objectStack.peek();
			driver.name = (driver.name != null ? driver.name : "") + value;
			...
			vehicle.vehicleId = (vehicle.vehicleId != null ? vehicle.vehicleId
					: "") + value;
